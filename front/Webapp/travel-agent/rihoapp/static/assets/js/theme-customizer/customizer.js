    ...
    $(".sidebar-type li").on("click", function () {
      ...
      switch (type) {
        ...
        case "normal-sidebar": {
          ...
          $(".logo-wrapper")
            .find("img")
            .attr("src", "/riho/rihoapp/static/assets/images/logo/logo.png");
